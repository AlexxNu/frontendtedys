    ...
    public function ctrRegistroUsuario(){
        if(isset($_POST["regUsuario"])){
            ...
            if($respuesta == "ok"){
				...
				$mail->CharSet = 'UTF-8';
                $mail->isMail();
                $mail->setFrom('jesusalejandronj@gmail.com','Tedys Toys');
                $mail->addReplyTo('jesusalejandronj@gmail.com','Tedys Toys');
					...
					if($respuesta["verificacion"] == 1){
						echo '<script> 
							...
							swal({
								  ...
								  text: "¡Por favor revise la bandeja de entrada o la carpeta de SPAM de su correo electrónico '.$respuesta["email"].' para verificar la cuenta!",
								  type:"error",
								  confirmButtonText: "Cerrar",
								  closeOnConfirm: false
								},
	...
	public function ctrEliminarUsuario(){
		...
		if(isset($_GET["id"])){
			...
			if($_GET["foto"] != ""){
				...
				unlink($_GET["foto"]);
				rmdir('views/images/usuarios/'.$_GET["id"]);
