			...
			<?php
				...
				if(!$compras){
					...
					foreach ($compras as $key => $value1) {
						...
						$productos = ControllerProducts::ctrListarProductos($ordenar, $item, $valor);
									...
									<div class="panel-body">
										...
										<div class="col-md-2 col-sm-6 col-xs-12">
											...
											<figure>
												...
												<img class="img-thumbnail" src="'.$server.$value2["portada"].'">
								...
								echo '<li class="col-md-3 col-sm-6 col-xs-12">
										...
										<figure>
											...
											<a href="'.$url.$value2["ruta"].'" class="pixelProducto">
												...
												<img src="'.$server.$value2["portada"].'" class="img-responsive">
											...
											<div class="btn-group pull-right">
												...
												<button type="button" class="btn btn-danger btn-xs quitarDeseo" idDeseo="'.$value1["id"].'" data-toggle="tooltip" title="Quitar de mi lista de deseos">
													...
													if($value2["oferta"] != 0){
														...
														echo '<button type="button" class="btn btn-default btn-xs agregarCarrito"  idProducto="'.$value2["id_product"].'" imagen="'.$server.$value2["portada"].'" titulo="'.$value2["titulo"].'" precio="'.$value2["precioOferta"].'" peso="'.$value2["peso"].'" data-toggle="tooltip" title="Agregar al carrito de compras">
														...
														echo '<button type="button" class="btn btn-default btn-xs agregarCarrito"  idProducto="'.$value2["id_product"].'" imagen="'.$server.$value2["portada"].'" titulo="'.$value2["titulo"].'" precio="'.$value2["precio"].'" peso="'.$value2["peso"].'" data-toggle="tooltip" title="Agregar al carrito de compras">
...
<div class="modal-header">
        ...
        <h3 class="modal-title">CALIFICA ESTE PRODUCTO</h3>
      </div>
