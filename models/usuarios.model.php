...
class ModeloUsuarios{
    ...
    static public function mdlRegistroUsuario($tabla,$datos){
        $stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(nombre, password, email, foto, modo, tipo, verificacion, emailEncriptado) VALUES (:nombre, :password, :email, :foto, :modo, :tipo, :verificacion, :emailEncriptado)");
